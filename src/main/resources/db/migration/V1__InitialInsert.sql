...
--FOR DEMO ONLY
--PLEASE COMMENT THEM IF THEY ARE NOT USED
INSERT INTO user_base (username, password, user_type, pin, status)
VALUES ('betha', 'password123', 1, '123456', 0)
ON CONFLICT (username) DO NOTHING
RETURNING id;

INSERT INTO account_base (account_number, user_id, account_type, bs_balance, current_balance, status)
VALUES ('2024031100001', 1, 1, 5000000.00, 5000000.00, 1)
ON CONFLICT (account_number) DO NOTHING;

INSERT INTO ledger_transaction (account_number, before_balance, trx_amt, after_balance, global_id, remark, created_by)
VALUES ('2024031100001', 0.00, 5000000.00, 5000000.00, '4214122312422', 'Deposit Transaction', 'betha')
ON CONFLICT (id) DO NOTHING;

INSERT INTO ledger_base (id, reference_no, account_code, trx_amount, global_id, created_at, updated_at)
VALUES (1, '2024031100001', '24033123', 5000000.00, 4214122312422, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;

UPDATE ledger_master
SET credit_amt = 5000000, total_amt=5000000, updated_at = CURRENT_TIMESTAMP
WHERE account_code = '24033123'
RETURNING id, account_code, credit_amt;

UPDATE ledger_master
SET credit_amt = 5000000, total_amt=5000000, updated_at = CURRENT_TIMESTAMP
WHERE account_code = '10908213'
RETURNING id, account_code, credit_amt;
